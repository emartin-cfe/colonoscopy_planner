<?php
	...
	# Now generate a link
	$link = "<a href='http://aiddly.com/colonoscopy_planner/GUIDE/consent.php?auth=$SHA1'>http://aiddly.com/consent</a>";

	$to = $patient_email;
	$from = "pacific.gastro.associates@gmail.com";
	$subject = "Re: colonoscopy appointment";

	$html = 	"<p>On behalf of Pacific Gastroenterology, I am contacting you because you have been scheduled for a colonoscopy on <b>$formatted_date</b> at St. Paul's hospital (GI clinic). " .
				"It is important that you prepare properly, as this will make it easier for both you and Dr. Enns. We have created an online guide that is tailored to your appointment. " .
				"Please take the time to read it, as it contains advice that will help you complete the procedure successfully while reducing discomfort.</p>" .
	...
	$config=array(	'host' => 'ssl://smtp.googlemail.com', 'port' => 465,
					'auth' => true, 'username' => 'pacific.gastro.associates@gmail.com', 'password' => 'ColonPrep4'
					);
